...
func NewErrorCodeRegistry() *ErrorCodeRegistry {
	...
	registry.register("E046", "validation", "Content required for approved status")
	...
	registry.register("E051", "validation", "Missing required schema rule field")
	registry.register("E052", "validation", "Field type mismatch")
	registry.register("E053", "validation", "Invalid enum value")
	registry.register("E054", "validation", "Cross-reference not found")
	registry.register("E055", "validation", "Doc file not found")
	registry.register("E056", "validation", "Missing keyword in doc")
	...
	registry.register("E103", "contract", "Duplicate contract name")
	registry.register("E104", "contract", "Contract has no steps")
